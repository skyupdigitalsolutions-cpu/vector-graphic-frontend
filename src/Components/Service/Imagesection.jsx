...
export default function Imagesection() {
  ...
  return (
    <div className="flex items-end justify-center w-full max-w-5xl mx-auto px-4 overflow-visible h-[158px] md:h-[260px] lg:h-[347px] lg:w-[1280px] lg:px-[80px] pb-[50px] lg:pt-[30px] lg:mt-[120px] lg:pb-[90px]">
      {images.map((img, i) => {
