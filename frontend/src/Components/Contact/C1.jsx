...
export const C1 = () => {
  ...
  const formikk = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try {
        const response = await fetch("https://vector-graphics-backend.onrender.com/api/contacts", {
          method: "POST",
    ...
    <>
      <style>{`
        ...
        .c1-card {
          ...
          background:
            radial-gradient(ellipse 600px 300px at 18% 8%,  rgba(255,255,255,0.09) 0%, transparent 65%),
            radial-gradient(ellipse 500px 300px at 85% 90%, rgba(0,0,0,0.55)       0%, transparent 65%),
            radial-gradient(ellipse 400px 200px at 50% 50%, rgba(60,65,75,0.3)     0%, transparent 70%),
            linear-gradient(160deg, #2a2f38 0%, #1e2228 40%, #181c22 70%, #141720 100%);
        }
        ...
        .c1-submit {
          ...
          white-space: nowrap;
          flex-shrink: 0;
          box-shadow: 0 4px 16px rgba(201,32,32,0.45);
        ...
        @media (max-width: 640px) {
          ...
          .c1-desc {
            ...
            font-family: 'Poppins', sans-serif;
                font-weight: 400;
              line-height: 150%;   /* ✅ correct — gives natural multi-line wrapping */
              text-align: center;
              width: 353px;        /* matches Figma width */
              max-width: 100%;     /* safe on smaller screens */
              }

          .c1-form-bg { background: #181C23; }
          ...
          /* ✅ Checkbox on top, button below — left-aligned */
          .c1-bottom {
            flex-direction: column;
            align-items: center;
            gap: 25px;
          ...
          /* ✅ 190px wide × 52px tall — exact Figma match */
          .c1-submit {
            ...
            <div className="c1-card-glow">
              <div className="c1-card-wrap">
                <div className="c1-card">
                 ...
                 color: formikk.values.YourInterest === "" ? "#9ca3af" : "#111111",
             }}
    >
      <option value="" style={{ color: "#9ca3af" }}>Select</option>
      <option value="Design" style={{ color: "#111111" }}>Design</option>
      <option value="Printing" style={{ color: "#111111" }}>Printing</option>
      <option value="Packaging" style={{ color: "#111111" }}>Packaging</option>
    </select>
    <ChevronDown
      size={18}
      style={{
  ...
  {formikk.touched.YourInterest && formikk.errors.YourInterest && (
    <span style={errorStyle}>{formikk.errors.YourInterest}</span>
  )}
</div>
                      <div style={fieldStyle}>
