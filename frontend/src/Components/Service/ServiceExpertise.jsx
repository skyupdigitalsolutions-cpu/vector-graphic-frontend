...
export default function ServiceExpertise() {
  ...
  return (
    ...
    <section className="w-[393px] h-[511px] md:w-full md:h-auto md:min-h-0 lg:h-[730px] lg:w-full flex items-center justify-center bg-[#1a1a1a] overflow-hidden md:py-16">
